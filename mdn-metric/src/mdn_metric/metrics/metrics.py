...
from .classification import NearestMetricCallback, NearestGroupedMetricCallback, ScoresMetricCallback, QualityMetricCallback
from .classification import MAPMetricCallback, InvertedAccuracyMetricCallback
...
class Metrics:
    ...
    CLASSIFICATION_CALLBACKS = {
        "accuracy": lambda num_classes, labels_key, embeddings_key, final_weights_key, logits_key, confidences_key, quality_key, params: dl.AccuracyCallback(
            num_classes=num_classes,
            input_key=logits_key,
            target_key=labels_key,
            **params
        ),
        "inverted-accuracy": lambda num_classes, labels_key, embeddings_key, final_weights_key, logits_key, confidences_key, quality_key, params: InvertedAccuracyMetricCallback(
            input_key=logits_key,
            target_key=labels_key,
            **params
        ),
        "multilabel-accuracy": lambda num_classes, labels_key, embeddings_key, final_weights_key, logits_key, confidences_key,
                           quality_key, params: dl.MultilabelAccuracyCallback(
            input_key=logits_key,
            target_key=labels_key,
            **params
        ),
        "nearest": lambda num_classes, labels_key, embeddings_key, final_weights_key, logits_key, confidences_key, quality_key, params: NearestMetricCallback(
            input_key=embeddings_key,
            target_key=labels_key,
            config=params
        ),
        "nearest-grouped": lambda num_classes, labels_key, embeddings_key, final_weights_key, logits_key, confidences_key, quality_key, params: NearestGroupedMetricCallback(
            input_key=embeddings_key,
            target_key=labels_key,
            config=params
        ),
        "quality": lambda num_classes, labels_key, embeddings_key, final_weights_key, logits_key, confidences_key, quality_key, params: QualityMetricCallback(
            input_key=confidences_key,
            target_key=quality_key,
            config=params
        ),
        "scores": lambda num_classes, labels_key, embeddings_key, final_weights_key, logits_key, confidences_key, quality_key, params: ScoresMetricCallback(
            input_key=embeddings_key,
            target_key=labels_key,
            final_weights_key=final_weights_key,
            config=params
        ),
        "map": lambda num_classes, labels_key, embeddings_key, final_weights_key, logits_key, confidences_key, quality_key, params: MAPMetricCallback(
            input_key=logits_key,
            target_key=labels_key,
            config=params
        )
    ...
    def get_classification_callbacks(self, *, train, labels_key, embeddings_key,
                                     final_weights_key=None, logits_key=None,
