...
class Trainer:
    ...
    def get_default_config(num_epochs=16,
        ...
        Args:
            ...
            variance_scheduler_type: One of `None` and `exponential`.
            variance_scheduler_params: Parameters of the classifier variance scheduler.
            kld_scheduler_type: One of `None` and `linear`.
            kld_scheduler_params: Parameters of the weights KLD loss scheduler.
