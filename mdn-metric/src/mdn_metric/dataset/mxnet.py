...
class MXNetTrainset(Dataset):
    ...
    LABELS_FILENAME = "labels.npy"  # Use labels cache to speedup initialization.
...
class MXNetValset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return (Image.fromarray(image1), Image.fromarray(image2)), label
...
class SerializedDataset(Dataset):
    ...
    def __init__(self, index_path):
        ...
        self._labels = np.asarray(read_yaml(prefix + ".labels"))
